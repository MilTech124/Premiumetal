  ...
  return (
    <div className="bg-[url(/images/hero2.webp)] bg-cover flex  bg-no-repeat md:h-[400px] bg-bottom ">
      <div className="flex items-end w-full justify-between  max-md:flex-col">
        <div className="flex relative flex-col md:-mb-10 items-start justify-center h-full md:pl-[10%] pl-2 max-sm:pt-10">
            ...
            <Link href="/kontakt"><button className="btn md:absolute  bottom-5  bg-red">Kontakt</button></Link>
            </Fade>
        </div>
