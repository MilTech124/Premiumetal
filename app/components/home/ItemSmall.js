...
function SmallItem({ number, title,image }) {
  return (
    <div className="z-20 md:mr-10 ">
      <div className="flex">
        <p className="rounded-full text-center bg-red flex items-center justify-center -ml-5 -mb-5  w-10 h-10 text-lg text-white font-bold z-10 hover:bg-red-400 ">{number}</p>
